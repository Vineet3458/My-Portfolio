  ...
  const projects = [
    {
      ...
      description:
        "Built a responsive Spotify-style music player using React + Vite. Added full audio controls (play/pause, next/prev, progress bar). Developed reusable Tailwind components and optimized/deployed with Vite.",
      gradient: "from-green-400 to-emerald-600",
      link: "https://spotify-clone-by-vineet.vercel.app/",
    },
    {
      title: "Dev Investigator",
      tech: "GitHub API, HTML, CSS, JavaScript",
      description:
        "Built a web tool that fetches and displays GitHub user and repo data using the GitHub API. Implemented search, profile lookup, and repository insights with clean UI components.",
      gradient: "from-purple-400 to-indigo-600",
      link: "https://dev-investigator.vercel.app/",
    },
    {
      title: "Password Generator",
      tech: "HTML, CSS, JavaScript",
      description:
        "Built a secure password generator web app with customizable length and character sets. Added options for uppercase, lowercase, numbers, special characters, copy-to-clipboard, and real-time strength handling.",
      gradient: "from-orange-400 to-red-600",
      link: "https://password-generator-vert-beta.vercel.app/",
    },
  ];
